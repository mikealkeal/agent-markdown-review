...
| **2 — Semantic** | gaps, contradictions, dubious claims | a fresh-context reviewer | one cheap model call, only when a `.md` changed |
...
- Running a fresh-context review on every micro-edit — costly; that is why Layer 2 is on the yield/commit boundary and gated by content change.
